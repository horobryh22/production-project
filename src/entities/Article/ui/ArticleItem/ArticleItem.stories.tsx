...
const article = {
    ...
    type: ['IT', 'ECONOMICS', 'IT', 'ECONIMICS', 'IT', 'IT', 'IT', 'IT'],
    blocks: [
        {
            id: '1',
            type: 'TEXT',
...
const SkeletonTemplate: ComponentStory<typeof ArticleItemSkeleton> = args => (
    <ArticleItemSkeleton {...args} />
);
...
export const TILELoading = SkeletonTemplate.bind({});
TILELoading.args = {
    view: ArticleView.TILE,
};
...
export const LISTLoading = SkeletonTemplate.bind({});
LISTLoading.args = {
    view: ArticleView.LIST,
};
